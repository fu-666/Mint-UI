      ...
      <mt-tab-container v-model="active">
        <mt-tab-container-item id="1">
          ...
          <div class="articleItem" v-for="(v,k) of 10" :key="k">
            <!-- 文章标题开始 -->
            <router-link :to="`/article/${k+1}`">
              <div class="articleItem-header">税后年薪十万、二十万、三十万的汽车工程师的真实生活</div>
              <!-- 文章标题结束 -->
              <!-- 文章图文信息开始 -->
              <div class="articleItem-wrapper">
                <!-- 文章图像开始  -->
                <div class="articleImg">
                  <img src="../assets/images/articles/liminhao2.jpg" />
                </div>
                <!-- 文章图像结束 -->
                <!-- 文章简介开始 -->
                <div
                  class="articleDes"
                >第一次回答这么私密的问题，紧张兮兮！跟众多行业前辈比起来，我可能是一个汽车界的萌新了，研究生毕业工作还不满两年。工资水平自然也是处于第一档。自报一下家门，目前在上汽乘用车工作，市场部，虽然目前做的是市场部工作，但是本科研究生读的都是车辆工程专业，而且由于对汽车的喜欢，也一直没有完全丢掉。所以在我们品牌传播这里，涉及到底层机械电气等原理的部分，一般都会来问问我，算是一项差异化优势吧。上汽乘用车地处于</div>
                <!-- 文章简介结束 -->
              </div>
            </router-link>
            <!-- 文章图文信息结束 -->
